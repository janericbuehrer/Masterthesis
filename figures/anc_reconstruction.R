...
p_anc <- processAncStates(result_file_vegf, state_labels = c("0" = "closed", 
                                                        "1" = "open", 
                                                        "2" = "both"))
# clim biome                                                                            # However, I don't know how to label them on a later stage as i am not able to extract them out of this datatype.
...
pdf(paste0(path, "plots/anc_reconstruction/pie_anc_states_vegf_m6.pdf"), width = 20, height = 20)
...
fig_name <- "ClaSSE_Gentiana_BiomeOnly" 
ggsave(paste0(fig_name, "_m3.png"), plot_states, width=10, height=10)
